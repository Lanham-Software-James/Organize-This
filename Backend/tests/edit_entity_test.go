...
// type enditEntityTestCase struct {
// 	testName       string
// 	entityName     string
// 	entityNotes    string
...
// func validateEditEntitySuccessResponse(t *testing.T, res *http.Response, mockDB sqlmock.Sqlmock, mockCache redismock.ClientMock, testID uint) {
...
// // TestEditEntityInvalid runs the unit tests for invalid cases.
// func TestEditEntityInvalid(t *testing.T) {
...
// 				setupEditEntityMockExpectations(&mockDB, mockCache, tc.entityCategory, tc.entityName, tc.entityNotes, tc.entityUser, strconv.Itoa(int(tc.entityID)), tc.entityAddress)
// 			} else {
// 				setupEditEntityMockExpectations(&mockDB, mockCache, tc.entityCategory, tc.entityName, tc.entityNotes, tc.entityUser, strconv.Itoa(int(tc.entityID)))
// 			}
...
// 			validateEditEntitySuccessResponse(t, res, mockDB, mockCache, tc.entityID)
// 		})
// 	}
// }

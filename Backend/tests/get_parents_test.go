...
func TestGetParents(t *testing.T) {
	cases := []getParentsTestCase{
		{
			testName:       "BEUT-99: Get Parents Invalid Category",
			testUser:       "testuser0",
			testValidInput: false,
			category:       "test",
		},
		{
			testName:       "BEUT-100: Get Parents Item Cache Miss",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   false,
			category:       "item",
		...
		{
			testName:       "BEUT-101: Get Parents Item Cache Hit",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   true,
			category:       "item",
		...
		{
			testName:       "BEUT-102: Get Parents Container Cache Miss",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   false,
			category:       "container",
		...
		{
			testName:       "BEUT-103: Get Parents Container Cache Hit",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   true,
			category:       "container",
		...
		{
			testName:       "BEUT-104: Get Parents Shelf Cache Miss",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   false,
			category:       "shelf",
		...
		{
			testName:       "BEUT-105: Get Parents Shelf Cache Hit",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   true,
			category:       "shelf",
		...
		{
			testName:       "BEUT-106: Get Parents Shelving Unit Cache Miss",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   false,
		...
		{
			testName:       "BEUT-107: Get Parents Shelving Unit Cache Hit",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   true,
			category:       "shelving_unit",
		...
		{
			testName:       "BEUT-108: Get Parents Room Cache Miss",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   false,
			category:       "room",
		...
		{
			testName:       "BEUT-109: Get Parents Room Cache Hit",
			testUser:       "testuser0",
			testValidInput: true,
			testCacheHit:   true,
			category:       "room",
